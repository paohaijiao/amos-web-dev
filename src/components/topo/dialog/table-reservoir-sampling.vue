<template>
  ...
  <div style="min-height: 400px" :visible="dialogVisible">
    ...
    <div class="form-group">
      <label  >种子大小</label>
      <input type="text" class="form-control"    v-model="form.sample_size" placeholder="请输入步骤名称">
    </div>
    <div class="form-group">
      <label  >种子</label>
      <input type="text" class="form-control"    v-model="form.seed" placeholder="请输入步骤名称">
    </div>
