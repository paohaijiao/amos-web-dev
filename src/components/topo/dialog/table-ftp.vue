<template>
  ...
  <div class="modal-header">
    <h4 class="modal-title">Ftp下载</h4>
  </div>
  <div class="form-group">
    <label for="name" >步骤名称</label>
    <input type="text" class="form-control" id="name"   v-model="form.name"   value="Ftp"
           placeholder="Ftp" disabled>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control"    v-model="form.targetdirectory"
           placeholder="请输入本地目录" >
  </div>
