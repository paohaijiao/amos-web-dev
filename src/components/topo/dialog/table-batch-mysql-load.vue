<template>
  <div style="min-height: 400px" :visible="dialogVisible">
    <div class="modal-header">
      <h4 class="modal-title">MySQL 批量加载</h4>
    </div>
    <div class="form-group">
      <label for="name" >步骤名称</label>
      <input type="text" class="form-control" id="name"   v-model="form.name"   value="MYSQL_BULK_LOAD"
             placeholder="MYSQL_BULK_LOAD" disabled>
    </div>
    <div class="form-group">
      <label >数据源</label>
    ...
    <div class="form-group">
      <label for="name" >逃逸符</label>
      <input type="text" class="form-control"    v-model="form.escaped"   value="请输入逃逸符"
             placeholder="逃逸符" >
    </div>
    <div class="form-group">
      <label for="name" >行分隔符</label>
      <input type="text" class="form-control"    v-model="form.lineterminated"   value="请输入行分隔符"
             placeholder="行分隔符" >
    </div>
