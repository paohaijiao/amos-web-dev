<template>
  ...
  <div style="min-height: 400px" :visible="dialogVisible">
    <div class="modal-header">
      <h4 class="modal-title">Java代码</h4>
    </div>
    ...
    <div class="form-group">
      <label for="name" >JAVA代码</label>
      <textarea type="text" class="form-control"  :rows="15"  v-model="form.class_source" placeholder="请输入java代码"></textarea>
    </div>
