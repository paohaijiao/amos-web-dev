<template>
  <div style="min-height: 400px" :visible="dialogVisible">
    <div class="modal-header">
      <h4 class="modal-title">删除hdfs文件</h4>
    </div>
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control"    v-model="form.user" placeholder="请输入hdfs权限的用户名字段">
    </div>
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control"    v-model="form.uri" placeholder="请输入fs.defaultFS路径字段">
    </div>
    <div class="form-group">
      <label  >输出字段</label>
