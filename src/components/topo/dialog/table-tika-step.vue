<template>
  <div style="min-height: 400px" :visible="dialogVisible">
    ...
    <div class="form-group">
      <label >解析后内容存放的字段</label>
      <input type="text" class="form-control"    v-model="form.fieldName" placeholder="解析后内容存放的字段">
    </div>


    <div class="form-group">
      <label  >文件路径字段</label>
      <input type="text" class="form-control"   v-model="form.filePath" placeholder="解析后内容存放的字段">
    </div>
