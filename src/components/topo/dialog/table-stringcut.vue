      ...
      <div class="box-body">
        <table class="table table-bordered"  >
          ...
          <tr v-for="item in tableData">
            ...
            <td>
              <input type="text" class="form-control" v-model="item.out_stream_name">
            </td>
            <td>
              <input type="text" class="form-control" v-model="item.cut_from">
            </td>
            <td>
              <input type="text" class="form-control" v-model="item.cut_to">
            </td>
            <td>
          ...
          this.$api.getFieldFromPreviousStep(param,res => {
              if (res.code === 200) {
                  ...
                  for(var i=0;i<array.length;i++){
                      ...
                      ele.out_stream_name=array[i].name+"1";
                      ele.cut_from=0;
                      ele.cut_to=0;
