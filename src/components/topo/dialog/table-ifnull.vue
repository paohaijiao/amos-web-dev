<template>
  <div style="min-height: 400px" :visible="dialogVisible">
    <div class="modal-header">
      <h4 class="modal-title">替换Null值</h4>
    </div>
      ...
      <div class="box-body">
        <table class="table table-bordered"  >
          ...
          <tr v-for="(item,index) in tableData">
            ...
            <td><input type="text" class="form-control" v-model="item.replace_value"></td>
            <td><input type="text" class="form-control" v-model="item.replace_mask"></td>
            <td>
              <select class="form-control select2 select2-hidden-accessible" v-model="item.set_empty_string">
