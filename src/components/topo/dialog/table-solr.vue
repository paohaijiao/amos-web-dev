<template>
  <div style="min-height: 400px" :visible="dialogVisible">
    ...
    <div class="form-group">
      <label  >Url</label>
      <input type="text" class="form-control"    v-model="form.url" placeholder="请输入Url">
    </div>
    <div class="form-group">
    ...
    <div class="box-body">
      ...
      <table class="table table-bordered"  >
        ...
        <tr v-for="(item,index) in tableData">
          ...
          <td>
            <input type="text" class="form-control" v-model="item.arg_parameter">
          </td>
          <td>
          ...
          this.$api.getFieldFromPreviousStep(param,res => {
              if (res.code === 200) {
                  ...
                  for(var i=0;i<array.length;i++){
                      ...
                      ele.arg_parameter=array[i].name;
