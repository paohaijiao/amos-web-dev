<template>
  <div style="min-height: 400px" :visible="dialogVisible">
    <div class="modal-header">
      <h4 class="modal-title">Hadoop file Input</h4>
    </div>
    ...
    <div class="form-group">
      <label for="name" >文件名(样例: hdfs://root:13579admin@192.168.30.14:9000/haha.txt)</label>
      <input type="text" class="form-control"    v-model="form.file_name" placeholder="请输入文件名">
    </div>
    <div class="form-group">
      <label for="name" >分隔符(样例: ;)</label>
      <input type="text" class="form-control"    v-model="form.separator" placeholder="请输入分隔符">
    </div>
    <div class="form-group">
      <label for="name" >封闭符(样例: \)</label>
      <input type="text" class="form-control"    v-model="form.enclosure" placeholder="请输入封闭符">
    </div>

    <div class="form-group">
      <label for="name" >hadoop集群名称</label>
      <input type="text" class="form-control"    v-model="form.source_configuration_name" placeholder="请输入hadoop集群名称">
    </div>
    <div class="form-group">
