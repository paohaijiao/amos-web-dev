<template>
  <div style="min-height: 400px" :visible="dialogVisible">
    <div class="modal-header">
      <h4 class="modal-title">检查是否连接到资源库</h4>
    </div>
    <div class="form-group">
      <label for="name" >步骤名称</label>
      <input type="text" class="form-control" id="name"   v-model="form.name"   value="CONNECTED_TO_REPOSITORY"
             placeholder="CONNECTED_TO_REPOSITORY" disabled>
    </div>
    <div class="form-group">
