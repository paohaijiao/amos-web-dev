<template>
  <div style="min-height: 400px" :visible="dialogVisible">
    ...
    <div class="form-group">
      <label  >源字段</label>
      <input type="text" class="form-control"    v-model="form.key_name" placeholder="请输入源字段">
    </div>
    <div class="form-group">
      <label  >目标字段</label>
      <input type="text" class="form-control"    v-model="form.key_field" placeholder="请输入目标字段">
    </div>
    <div class="form-group">
      <label  >条件</label>
      <select  v-model="form.key_condition" class="form-control select2 select2-hidden-accessible">
