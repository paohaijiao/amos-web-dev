<template>
  ...
  <div style="min-height: 400px" :visible="dialogVisible">
    <div class="modal-header">
      <h4 class="modal-title">从hdfs下载文件到本地</h4>
    </div>
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control"  v-model="form.path" placeholder="请输入路径字段1">
    </div>
    <div class="form-group">
      <label for="name" >defaultFS 字段</label>
      <input type="text" class="form-control"  v-model="form.uri" placeholder="请输入defaultFS 字段">
    </div>
