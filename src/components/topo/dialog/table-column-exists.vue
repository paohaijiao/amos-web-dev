<template>
  <div style="min-height: 400px" :visible="dialogVisible">
    <div class="modal-header">
      <h4 class="modal-title">Column是否存在</h4>
    ...
    <div class="form-group">
      <label  >目标模式</label>
      <input type="text" class="form-control"    v-model="form.schemaname" placeholder="请输入模式内容">
    </div>
    <div class="form-group">
      <label  >目标表</label>
      <input type="text" class="form-control"    v-model="form.tablename" placeholder="请输入目标表">
    </div>
    <div class="form-group">
      <label  >字段名字段</label>
      <input type="text" class="form-control"    v-model="form.columnnamefield" placeholder="请输入字段名字段">
    </div>
    <div class="form-group">
      <label  >结果字段名</label>
