<template>
  <div style="min-height: 400px" :visible="dialogVisible">
    <div class="modal-header">
      <h4 class="modal-title">映射（目录要多一个/）</h4>
    </div>
    ...
    <div class="form-group">
      <label  >目录名</label>
      <input type="text" class="form-control"    v-model="form.directory_path" placeholder="请输入目录名">
    </div>
    <div class="form-group">
      <label  >转换名</label>
      <input type="text" class="form-control"    v-model="form.trans_name" placeholder="请输入转换名">
    </div>
    <div><span>输入</span>&nbsp;
    ...
    <div class="box-body">
      ...
      <table class="table table-bordered"  >
        ...
        <tr v-for="(list,index) in tablelist">
          <td><input type="text" class="form-control" v-model="list.key"></td>
          <td>
