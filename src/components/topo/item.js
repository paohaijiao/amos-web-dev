import { type, bgColor, icon } from './enum'
...
class Item {
  constructor(params) {
    ...
    this.inputIds = params.inputIds || []
    this.outputIds = params.outputIds || []
    this.inputPathIds = params.inputPathIds || []
    this.outputPathIds = params.outputPathIds || []
  ...
  _createElement() {
    ...
    let title = this.title || this.name
    this._text = text
    text
      .text(title)
      .attr('x', 73)
      ...
      // .css({'width':'80px',"margin-left":"0px"})
